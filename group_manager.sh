...
sudo -E apt-get install -y libstdc++-4.8-dev libdpkg-perl dpkg-dev build-essential libpq-dev gcc-4.9 g++-4.9 nodejs nodejs-dev postgresql-9.3 libpq-dev postgres-c g++
...
/usr/lib/postgresql/9.3/bin/initdb --encoding=UTF-8 --locale=ja_JP.UTF-8
